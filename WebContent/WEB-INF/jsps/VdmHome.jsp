...
<table class="table">
    ...
    <tbody>
       <tr> 
			...
			<td></td>
			<td>
               <a href="viewAllVen" class="blue-text"><i class="fa fa-user"> </i></a>
            </td>
        </tr>
         <tr> 
            <td></td>
			...
			<td></td>
			<td>
               <a href="viewAllSeller" class="blue-text"><i class="fa fa-user"> </i></a>
            </td>
        </tr>
         <tr> 
            <td></td>
			...
			<td></td>
			<td>
               <a href="viewAllCons"  class="blue-text"><i class="fa fa-user"> </i></a>
            </td>
        </tr>
         <tr> 
            <td></td>
			...
			<td></td>
			<td>
               <a  href="viewAllLoc" class="blue-text"><i class="fa fa-user"> </i></a>
            </td>
        </tr>
        <tr> 
            <td></td>
