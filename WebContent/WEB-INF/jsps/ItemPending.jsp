...
<table class="table">
    ...
    <tbody>
       ...
       <tr>
			...
			<td>
			   <a href="itemApproved?itemId=<c:out value="${item.itemId}"/>" class="blue-text">Approved</a>
               <a href="itemReject?itemId=<c:out value="${item.itemId}"/>" class="teal-text">Reject</a>
			...
			<td>
               ...
               <a href="deletePendingItem?itemId=<c:out value="${item.itemId}"/>" class="red-text"><i class="glyphicon glyphicon-trash"></i></a>
            </td>
            </tr>
          </c:if>				
	   </c:forEach>
