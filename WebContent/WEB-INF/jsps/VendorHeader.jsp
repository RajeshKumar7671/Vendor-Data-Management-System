		...
		<ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
		     ...
		     <ul class="dropdown-menu">
               <li><a href="venPro?venId=<c:out value="${venObj.venId}"/>"><span class="glyphicon glyphicon-user"></span>Profile</a></li>
               <li><a href="venSett?venId=<c:out value="${venObj.venId}"/>"><span class="glyphicon glyphicon-cog"></span>Setting</a></li>
               <li><a href="venChangePwd?venId=<c:out value="${venObj.venId}"/>"><span class="glyphicon glyphicon-edit"></span>Change Password</a></li>
               <li><a href="logoutVen"><span class="glyphicon glyphicon-log-out"></span>Logout</a></li>
            </ul>
		 </li>
	    </ul> 
		</c:otherwise>
   ...
   <div class="row row2">
    ...
    <div class="collapse navbar-collapse" id="myNavbarbottom">
      <ul class="nav navbar-nav navbar-left">
		<li><a class="dropdown-toggle" href="venHome">HOME</a> </li>
        <li class="dropdown" >
